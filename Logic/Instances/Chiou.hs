...
instance (Logic (Sentence v p f), Ord v, IsString v, Eq p, Boolean p, Eq f, Skolem f) =>
...
instance (PropositionalLogic (Sentence v p f) (Sentence v p f), Ord v, IsString v, Eq p, Boolean p, Eq f, Skolem f) =>
