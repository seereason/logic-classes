...
contrapositives :: forall fof atom v. (IsQuantified fof atom v, Ord fof) => Set.Set fof -> Set.Set (Set.Set fof, fof)
contrapositives cls =
...
mexpand :: forall fof atom term v f. (IsQuantified fof atom v, IsLiteral fof atom, IsTerm term v f, Atom atom term v, Ord fof) =>
...
puremeson :: forall fof atom term v f. (IsQuantified fof atom v, IsLiteral fof atom, IsTerm term v f, Atom atom term v, Ord fof) =>
...
meson :: forall m fof atom term f v. (IsQuantified fof atom v, IsPropositional fof atom, IsLiteral fof atom, IsTerm term v f, Atom atom term v, Ord fof, Monad m) =>
