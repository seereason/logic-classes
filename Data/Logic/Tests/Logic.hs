...
-}
    ...
    , myTest "Logic - socrates is mortal, truth table"
                (([Predicate (Apply "H" [FunApp toSkolem 1 []]),
                   Predicate (Apply "H" [FunApp toSkolem 2 []]),
                   Predicate (Apply "M" [Var "z"]),
                   Predicate (Apply "M" [FunApp toSkolem 2 []]),
                   Predicate (Apply "S" [Var "z"]),
                   Predicate (Apply "S" [FunApp toSkolem 1 []])],
                  Just (CJ [DJ [A (Predicate (Apply "H" [FunApp toSkolem 2 []])),
                                A (Predicate (Apply "M" [Var "z"])),
                                A (Predicate (Apply "S" [FunApp toSkolem 1 []])),
                                N (A (Predicate (Apply "S" [Var "z"])))],
                            DJ [A (Predicate (Apply "H" [FunApp toSkolem 2 []])),
                                  A (Predicate (Apply "M" [Var "z"])),
                                  N (A (Predicate (Apply "H" [FunApp toSkolem 1 []]))),
                                  N (A (Predicate (Apply "S" [Var "z"])))],
                            DJ [A (Predicate (Apply "M" [Var "z"])),
                                A (Predicate (Apply "S" [FunApp toSkolem 1 []])),
                                N (A (Predicate (Apply "M" [FunApp toSkolem 2 []]))),
                                N (A (Predicate (Apply "S" [Var "z"])))],
                            DJ [A (Predicate (Apply "M" [Var "z"])),
                                N (A (Predicate (Apply "H" [FunApp toSkolem 1 []]))),
                                N (A (Predicate (Apply "M" [FunApp toSkolem 2 []]))),
                ...
                (table (for_all "x" (s [x] .=>. h [x]) .&. for_all "y" (h [y] .=>. m [y]) .=>. for_all "z" (s [z] .=>. m [z])))
